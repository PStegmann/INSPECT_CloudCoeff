"""
    file: plot_legendre_IR.py
    
    Description:
    ============
    Reads the CRTM CloudCoeff.bin scalar Legendre expansion
    coefficients from ../build/output/Legendre_terms_IR.txt
...
# Read CRTM IR Legendre expansion coefficients for the
# phase function.
coeff = np.loadtxt("../build/output/Legendre_terms_IR.txt")
